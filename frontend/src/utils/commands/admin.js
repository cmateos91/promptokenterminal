  ...
  'setup-pool': async (args) => {
    ...
    try {
      ...
      if (!mockWalletState.connected) {
        return { 
          type: 'error', 
          content: '🔒 Connect wallet first. Admin operations require wallet connection.' 
        };
      }
...
⚠️  Only use on devnet for testing!`
  ...
  'contract-info': async () => {
    ...
    try {
      ...
      return {
        type: 'result',
        content: `🏗️ CONTRACT INFORMATION\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n🆔 Program ID:       ${health.programId}\n✅ Deployed:         ${health.programDeployed ? 'Yes' : 'No'}\n🏃 Executable:       ${health.executable ? 'Yes' : 'No'}\n📊 Data Length:      ${health.dataLength} bytes\n👤 Owner:            ${health.owner || 'Unknown'}\n🌐 RPC Endpoint:     ${health.connection.endpoint}\n🔗 Commitment:       ${health.connection.commitment}\n⏱️  Response:         ${duration.toFixed(0)}ms\n\n🔧 Available Instructions:\n• initialize_pool\n• stake_tokens\n• unstake_tokens  \n• claim_rewards\n• fund_reward_pool`
      };
